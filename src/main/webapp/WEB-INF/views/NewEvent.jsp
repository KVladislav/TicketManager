...
<center>
    ...
    <label class="my-control-label" required for="inputTime">Время мероприятия</label>
...
<div class="control-group">
    <label class="my-control-label" required warning for="description">Наименование</label>

    <div class="my-controls">
        <textarea rows="5" id="description" set var="name" name="description"></textarea>
    </div>
</div>

<div class="control-group">
    <label class="my-control-label" warning for="timeRemoveBooking">Установка времени удаления брони</label>

    <div class="my-controls">
        <input type="text" id="timeRemoveBooking" required name="timeRemoveBooking">
...
<tr>
    ...
    <td>
        <div>
            <input type="text" id="inputPrice0" required pattern="^([0-9]*)\.([0-9]*)+$" title="только double числа"
                   name="price0">
        </div>
    </td>
</tr>
