...
<div class="container" style="margin-bottom: 50px">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/Operators/OperatorEditSave.do"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 column">
                <input class="form-control input-md" type="password" name="password" size=20 maxlength=15 required
                       pattern="^[a-zA-Z0-9]{0,10}$" id="OperatorOldPass"
                       title="Латинские буквы и цифры от 6 до 10 символов">
            </div>
        </div>
        </c:if>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 column">
                <input class="form-control input-md" type="password" name="passwordNew" size=20 maxlength=15
                       pattern="^[a-zA-Z0-9]{0,10}$" id="OperatorNewPass1">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 column">
                <input class="form-control input-md" type="password" name="passwordNewRepeat" size=20 maxlength=15
                       pattern="^[a-zA-Z0-9]{0,10}$" id="OperatorNewPass2">
            </div>
        </div>
