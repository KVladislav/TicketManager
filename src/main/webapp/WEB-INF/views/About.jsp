...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/css/gal/css.css" media="screen" rel="stylesheet"
          type="text/css"/>
    <link href="${pageContext.request.contextPath}/resources/css/gal/style.css" class="piro_style" media="screen"
          title="white" rel="stylesheet" type="text/css"/>
...
<div style="float:left; margin-left: 30%; width:700px; display:block;">
    ...
    <table>
        <tr>
            <td>
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/1.jpg" class="pirobox_gall"
                       title="Владислав Карпенко">
            ...
            <td style="padding: 11px">
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/2.jpg" class="pirobox_gall"
                       title="Юрий Попов">
            ...
            <td>
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/3.jpg" class="pirobox_gall"
                       title="Екатерина Крылова">
        ...
        <tr>
            <td>
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/5.jpg" class="pirobox_gall"
                       title="Анна Стоянова">
            ...
            <td style="padding: 11px">
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/4.jpg" class="pirobox_gall"
                       title="Лариса Назаренко">
            ...
            <td>
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/6.jpg" class="pirobox_gall"
                       title="Виталий Сипличук">
        ...
        <tr>
            <td>
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/7.jpg" class="pirobox_gall"
                       title="Сергей Прокопов">
            ...
            <td style="padding: 11px">
                <center>
                    ...
                    <a href="${pageContext.request.contextPath}/resources/images/8.jpg" class="pirobox_gall"
                       title="Антон Галенда">
            ...
            <td>
                <center>
                    <a href="${pageContext.request.contextPath}/resources/images/9.jpg" class="pirobox_gall"
                       title="Александр Трибушный">
    ...
    <div>
        ...
        <div class="demo">
            <a href="${pageContext.request.contextPath}/resources/images/logo.jpg" class="pirobox_gall"
               title="JavaArt Team">
